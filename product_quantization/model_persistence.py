    ...
    def save_model(self, model,  
        ...
        try:
            ...
            state = {
                ...
                'sign_aware_encoding': getattr(model, 'sign_aware_encoding', False),
            }
        ...
        try:
            ...
            if algo == 'classical':
                ...
                model = QuantumProductQuantizationKNN(
                    ...
                    sign_aware_encoding=model_state.get('sign_aware_encoding', config.get('sign_aware_encoding', False))
                )
